...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'AsterMao@o365.asterme.net',
  ...
  email: 'mailto:AsterMao@o365.asterme.net',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/AsterMao',
    },
    {
      name: 'Telegram',
      link: '#',
